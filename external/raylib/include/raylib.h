...
RLAPI void *MemAlloc(unsigned int size); // TestInternal memory allocator
RLAPI void *MemRealloc(void *ptr, unsigned int size);

// TestInternal memory reallocator
RLAPI void MemFree(void *ptr); // TestInternal memory free
...
RLAPI void ImageDrawTriangleFan(Image *dst, const Vector2 *points,
                                int pointCount,
                                Color color);

// Draw a triangle fan defined by points within an image (first vertex is the center)
RLAPI void ImageDrawTriangleStrip(Image *dst, const Vector2 *points,
                                  int pointCount,
                                  Color color);
