...
//
// // TestInternal set game dir after full path is set and check if correct
// // TestInternal set game file after full path is set and check if correct
...
// // --------------------------------------------------
//
// // TestInternal init with, get dir, get file... all getters, basically
//
// // --------------------------------------------------
// // Save
// // --------------------------------------------------
