...
- `docs/`: module docs and contributor references under `docs/_Internal/Contributing/`.
...
- Follow project conventions in `docs/_Internal/Contributing/2_Coding_Guidelines/` (prefer linking a single primary
  guideline file when adding new docs).
