...
int smUpdate(float dt)
{
    ...
    {
        lgInternalLogWithArg(WARN, MODULE, CSE_NULL_SCENE_UPDATE_FN, tracker->currScene->name,
                             __func__,
                             CSQ_ABORT);
...
int smDraw(void)
{
    ...
    {
        lgInternalLogWithArg(WARN, MODULE, CSE_NULL_SCENE_DRAW_FN, tracker->currScene->name,
                             __func__,
                             CSQ_ABORT);
