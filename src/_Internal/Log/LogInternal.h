...
#define SMILE_INFO(module, funcName, info)                      \
SMILE_Log(SMILE_LOG_INFO, module, "%s %s.", funcName, info)
#define SMILE_INFO_WITH_ARGS(module, info, name)                               \
...
#define SMILE_WARN(module, cause, funcName, conseq)                                      \
  SMILE_Log(SMILE_LOG_WARNING, module, "%s %s %s.", cause, funcName, conseq)
#define SMILE_WARN_WITH_ARGS(module, cause, name, funcName, conseq)                     \
  SMILE_Log(SMILE_LOG_WARNING, module, "%s '%s'. %s %s.", cause, name, funcName, conseq)
#define SMILE_WARN_FMT(module, fmt, ...)                                       \
  SMILE_Log(SMILE_LOG_WARNING, module, fmt, __VA_ARGS__)

#define SMILE_ERR(module, cause, funcName, conseq)                                       \
  SMILE_Log(SMILE_LOG_ERROR, module, "%s %s %s.", cause, funcName, conseq)
#define SMILE_ERR_WITH_ARGS(module, cause, name, funcName, conseq)                     \
  SMILE_Log(SMILE_LOG_ERROR, module, "%s '%s'. %s %s.", cause, name, funcName, conseq)
...
#define SMILE_FATAL(module, cause, funcName, conseq)                                     \
  SMILE_Log(SMILE_LOG_FATAL, module, "%s %s %s.", cause, funcName, conseq)
#define SMILE_FATAL_WITH_ARGS(module, cause, name, funcName, conseq)                     \
  SMILE_Log(SMILE_LOG_FATAL, module, "%s '%s'. %s %s.", cause, name, funcName, conseq)
